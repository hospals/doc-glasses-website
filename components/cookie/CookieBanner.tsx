          ...
          <div className="max-w-6xl mx-auto pointer-events-auto animate-banner-slide-up">
            <div className="bg-[#0f172a]/70 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl px-4 py-3 md:px-6 md:py-4 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 lg:gap-6 max-h-[40vh] overflow-y-auto">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-white font-semibold text-sm sm:text-base mb-1">We value your privacy</h3>
                <p className="text-white/70 text-xs sm:text-sm leading-relaxed max-w-3xl">
                  We use cookies to enhance your experience. Read our{" "}
                  <Link href="/privacy-policy" className="text-teal-400 hover:text-teal-300 underline underline-offset-4 transition-colors focus:outline-none focus:ring-1 focus:ring-teal-400/50 rounded">
                    Privacy Policy
                  </Link>{" "}
                  and{" "}
                  <Link href="/terms-of-service" className="text-teal-400 hover:text-teal-300 underline underline-offset-4 transition-colors focus:outline-none focus:ring-1 focus:ring-teal-400/50 rounded">
                    Terms of Service
                  </Link>.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full lg:w-auto shrink-0 mt-1 lg:mt-0">
                ...
                <div className="flex flex-row gap-2.5 w-full sm:w-auto order-2 sm:contents">
                  <button
                    ...
                    className="flex-1 sm:flex-none px-4 py-2.5 text-xs sm:text-sm font-medium text-white/90 border border-white/20 hover:bg-white/5 rounded-xl transition-all sm:order-2 focus:outline-none focus:ring-1 focus:ring-white/30 text-center"
                  >
                    Reject All
                  </button>
                </div>
