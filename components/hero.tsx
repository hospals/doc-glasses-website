				...
				<div style={{ padding: '24px' }}>
					...
					<div
						style={{
							...
							borderRadius: 12,
							padding: '14px',
							height: 110, // ✅ FIXED HEIGHT (adjust as needed)
							position: 'relative', // ✅ needed for absolute children
							overflow: 'hidden', // ✅ prevents overflow jump
						}}
					>
						...
						<div style={{ position: 'relative', height: 'calc(100% - 20px)' }}>
							{TRANSCRIPT_FRAMES.map((frame, i) => (
								...
								>
									<TranscriptLine frame={frame} visible={frameIdx === i} />
								</motion.div>
							))}
						</div>
					</div>
...
export default function Hero() {
	...
	return (
		...
		>
			...
			{/* ── CONTENT ── */}
			<div className='relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-[100px] lg:py-[50px]'>
				<motion.div
